        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="produtos.php">Add produto</a>
                    </li>
					<li>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-6">
                    ...
                    <form name="BuscaProdutos" method="POST" action="inicio.php">
					 <tr><td>Categoria:
                        <td>
                        <?php
              ...
              <?php
                       while($linha=mysql_fetch_array($resultado)) 
                        ...
                        ?>
                           ...
                           <a href="inicio.php">Fechar estoque</a>
                      
                        </br>
					</br>
					<h4> Listar Usuários</h4>
					</br>
					<form name="buscarvendas"  action="inicio.html" method="POST">
					<div>
                    <tr><td>Usuarios:
                        <td>
                        <?php
                     ...
                     <a href="CadPagamento.php">Cadastrar formas de pagamento</a>
                </div>
