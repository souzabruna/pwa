        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                 ...
                 <div align="center">
                <form name="FornecedorAdd" method="POST" action="cadastros.php">
            ...
            <tr>
                <td> CNPJ: </td> <td><input type="cnpj" name="cnpj"></td>
            </tr>
            <tr>
                <td>Endereço: </td> <td><input type="endereco" name="endereco"></td>
            </tr>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    require("../controller/CadastroFornecedor.php");
}
?>
</div>
